...
@Composable
fun MainView(modifier1: Modifier = Modifier) {
    ...
    val bottomBar: @Composable () -> Unit = {
        if (currentScreen is Screen.DrawerScreen ||
            ...
            BottomNavigation(modifier = Modifier.wrapContentSize(),
                backgroundColor = Color(0xFF43d14a)) {
...
fun DrawerItem(
    ...
    val background = if (selected) Color(0xff757575) else Color.Transparent
